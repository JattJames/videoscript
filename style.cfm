...
<cfinvoke component="#request.cfcPath#.themes" method="defaultTheme" returnvariable="ShowDesign"/>
<cfif ShowDesign.recordcount>
  <cfset bodybgcolor = #ShowDesign.themebgcolor#>
  <cfset themefontcolot = #ShowDesign.themefntcolor#>
  <cfset themelnkcolor = #ShowDesign.themelnkcolor#>
  <cfset themelnkaction = #ShowDesign..themelnkaction#>
  <cfset themehvraction = #ShowDesign.themehvraction#>
  <cfset themetopcell = #ShowDesign.themetopcell#>
  <cfset themebtmcell = #ShowDesign.themebtmcell#>
  <cfset themebrdcolor = #ShowDesign.themebrdcolor#>
  <cfset themebrdsize = #ShowDesign.themebrdsize#>
  <cfset themeMenuColor = #ShowDesign.themeMenuColor#>
  <cfset themelnkaction = #ShowDesign.themelnkaction#>
  <cfset themeboximagecolor = #ShowDesign.boximagecolor#>
  <cfset themeboximagecolorbottom = #ShowDesign.boximagecolorbottom#>
  <cfset boximagecolor = "admin/themes/#ShowDesign.themefoldername#/fon02.gif">
  <cfset repeatMode = "repeat">
  <cfelse>
